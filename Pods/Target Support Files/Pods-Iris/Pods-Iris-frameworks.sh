...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/Mapbox-iOS-SDK-stripped/dynamic/Mapbox.framework"
  install_dsym "${PODS_ROOT}/Mapbox-iOS-SDK-stripped/dynamic/Mapbox.framework.dSYM"
  install_bcsymbolmap "${PODS_ROOT}/Mapbox-iOS-SDK-stripped/dynamic/7F0A940A-54CB-3877-A6A3-4DA541C0EC59.bcsymbolmap"
  install_bcsymbolmap "${PODS_ROOT}/Mapbox-iOS-SDK-stripped/dynamic/3C6ECEFA-F844-32AF-9DA7-536738DDB263.bcsymbolmap"
